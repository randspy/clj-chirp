...
(describe "clj-chirp.usecases"
          ...
          (with! post (atom [{:user-name "user"
                              :posts [{:content "content one" :timestamp (time/date-time 2014)}
          ...
          (describe "Wall usecase is executed."
                    (with! post (atom [{:user-name "user"
                                        :posts [{:content "content" :timestamp (time/date-time 2014)}]
                                        :follows ["followed user"]}
                                       {:user-name "followed user"
                                        :posts [{:content "content" :timestamp (time/date-time 2014 02)}]}]))
